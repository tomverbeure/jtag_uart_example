...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/tom/altera/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/jtag_uart_jtag_uart_0.v" -work jtag_uart_0 -cdslib ./cds_libs/jtag_uart_0.cds.lib
